...
export const ROUTE_DEFINITIONS: RouteDefinition[] = [
  ...
  { path: '/buchung/erfolg', component: BookingReturn, routeClass: 'app-public', seoKey: 'booking' },
  { path: '/buchung/abbruch', component: BookingReturn, routeClass: 'app-public', seoKey: 'booking' },

...
export const HOME_V3: Record<Lang, HomeV3Strings> = {
  de: {
    ...
    price: {
      ...
      includes: ['8 Lektionen, einmal pro Woche', 'Gratis Schnupperstunde', 'Danceflow Nights ab 5 CHF'],
  ...
  en: {
    ...
    price: {
      ...
      includes: ['8 lessons, once a week', 'Free trial class', 'Danceflow Nights from 5 CHF'],
